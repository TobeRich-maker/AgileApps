...
import type { Project, CreateProjectRequest, ApiResponse, PaginatedResponse } from "../types/api"
...
export const projectsApi = {
  ...
  update: async (id: string, projectData: Partial<CreateProjectRequest>): Promise<Project> => {
