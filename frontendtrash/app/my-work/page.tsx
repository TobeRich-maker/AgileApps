    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="border-2 border-textcolorcustom-900 rounded-lg">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-textcolorcustom-600 dark:text-textcolorcustom-400">
                    Total Tasks
                  </p>
                  <p className="text-4xl font-bold text-success-700 dark:text-navy-100">
                    {stats.total}
                  </p>
                </div>
                <div className="p-2 bg-textcolorcustom-500 dark:bg-navy-800 rounded-lg">
                  <CheckCircle2 className="h-5 w-5 text-textcolorcustom-100 dark:text-navy-400" />
                </div>
              </div>
            </CardContent>
          </Card>
