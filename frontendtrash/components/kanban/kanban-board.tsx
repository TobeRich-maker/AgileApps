...
import { type Task, type TaskStatus, useSprintStore } from "@/lib/stores/sprint-store"
...
export function KanbanBoard({ onCreateTask, onEditTask, onDeleteTask }: KanbanBoardProps) {
        ...
        {columns.map((column) => (
          <div key={column.id} className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button size="sm" variant="outline" onClick={() => onCreateTask(column.id)} className="h-8 w-8 p-0">
